...
int al_push(ArrayList* this, int index, void* pElement)
{
    ...
    if(this!=NULL && this->pElements!=NULL && index>=0 && pElement!=NULL)
    {
...
ArrayList* al_subList(ArrayList* this,int from,int to)
{
    ...
    if(this!=NULL && from>=0 && from<this->size && from<to && to>=0 && to<=this->size)
    {
        returnAux=al_newArrayList();
        if(returnAux!=NULL)
        {
...
int al_sort(ArrayList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this!=NULL && pFunc != NULL && (order == 0 || order == 1))
    {
        for(i=0;i<al_len(this)-1;i++)
        {
            ...
            {
               if((pFunc(al_get(this,i),al_get(this,j))>0 && order) || (pFunc(al_get(this,i),al_get(this,j))<0 && !order) )
                {
                    auxPElement=al_get(this,i);
                    al_set(this,i,al_get(this,j));
                    al_set(this,j,auxPElement);
                }
            }
        }
        returnAux=0;
