...
/** \brief Solicita al usuario ingresar texto.
 *
 ...
 * \return int -1 Error de argumentos,0 OK.
 *
 */
int getStringTexto(char mensaje[],char input[]);
 ...
 *
 * \param mensaje[] char mensaje[] char Mensaje a mostrar cuando solicita ingresar una cadena de caracteres.
 * \param input[] char input[] char Devuelve la cadena de caracteres.
 * \return int 1.
 *
